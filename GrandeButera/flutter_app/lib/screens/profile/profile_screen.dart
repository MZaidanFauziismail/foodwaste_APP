...
class _ProfileScreenState extends State<ProfileScreen>
        ...
        headerSliverBuilder: (_, __) => [
          ...
          SliverPersistentHeader(
            ...
            delegate: _StickyTabBar(
              TabBar(
                controller: _tabCtrl,
                tabs: const [Tab(text: 'My listings'), Tab(text: 'My impact')],
            ...
            children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(user?.email ?? '',
                      style: TextStyle(fontFamily: 'Nunito', fontSize: 12, color: AppTheme.textSecondary),
                      overflow: TextOverflow.ellipsis),
                ]),
              ),
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            TweenAnimationBuilder<double>(
              ...
              child: Container(width: 72, height: 72,
                  ...
                  child: const Icon(Icons.inventory_2_outlined, color: AppTheme.primary, size: 36)),
            ),
            const SizedBox(height: 20),
            const Text("You haven't shared anything yet",
      ...
      children: [
        ...
        TweenAnimationBuilder<double>(
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text("Your impact on the world",
                  style: TextStyle(fontFamily: 'Nunito', fontSize: 16,
      ...
      builder: (_) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          const Text('Change photo',
              style: TextStyle(fontFamily: 'Nunito', fontSize: 18, fontWeight: FontWeight.w800, color: AppTheme.textPrimary)),
          const SizedBox(height: 16),
            ...
            child: Form(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('Edit profile',
                    style: TextStyle(fontFamily: 'Nunito', fontSize: 20, fontWeight: FontWeight.w800, color: AppTheme.textPrimary)),
                const SizedBox(height: 20),
                const Text('Name', style: TextStyle(fontFamily: 'Nunito', fontSize: 13, fontWeight: FontWeight.w700, color: AppTheme.textPrimary)),
                const SizedBox(height: 8),
                ...
                const SizedBox(height: 16),
                const Text('Bio', style: TextStyle(fontFamily: 'Nunito', fontSize: 13, fontWeight: FontWeight.w700, color: AppTheme.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(controller: bioCtrl, maxLines: 3,
                    style: const TextStyle(fontFamily: 'Nunito', fontSize: 15, color: AppTheme.textPrimary),
  ...
  InputDecoration _deco(String hint) => InputDecoration(
    ...
    filled: true, fillColor: const Color(0xFFF0EFF8),
